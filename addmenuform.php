...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if (mysqli_connect_errno()) {
    ...
    $sql = "INSERT INTO menu (MenuName, MenuPrice, MenuDescription, MenuAvailability)
            VALUES ('$name', '$price', '$type', '$availability')";
    $result = mysqli_query($dbc, $sql);
    if ($result) {
      echo "<script>alert('Menu item added successfully.'); window.location.href='addmenu.php';</script>";
    } else {
  ...
  <div class="main-content">
    <div class="form-container">
      ...
      <form method="POST" action="">
       ...
       <input class="form-input" name="MenuDescription" type="text" placeholder="Menu Description" required />
