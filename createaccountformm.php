  ...
  <div class="main-content">
    <div class="form-container">
      ...
      <form action="createaccountform.php" method="POST">
        ...
        <input class="form-input" type="CustUsername" name="CustUsername" placeholder="Username" required />
        ...
        <input class="form-input" type="CustDOB" name="CustDOB" placeholder="Staff Date Of Birth" required />
