...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if (mysqli_connect_errno()) {
    ...
    $sql = "INSERT INTO staff (StaffID, StaffName, StaffPhoneNum, StaffHouseNum, StaffPostcode, StaffCity, StaffState, StaffPosition, StaffDOB) 
            VALUES ('$id', '$name', '$phone', '$house', '$city', '$postcode', '$state', '$position', '$dob')";
